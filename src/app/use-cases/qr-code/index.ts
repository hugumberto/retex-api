...
import { GetCollectionRequestVolumesUseCase } from './get-collection-request-volumes-use-case';
...
export const QR_CODE_USE_CASES = [
  ...
  GetCollectionRequestVolumesUseCase,
...
export * from './get-collection-request-volumes-use-case';
